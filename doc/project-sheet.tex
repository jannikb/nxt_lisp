...
Unser NXT-Roboter soll auf nur einem oder evt. zwei Rädern stehen, die nebeneinander liegen, sodass er nicht von allein stehen kann und umfallen würden, wenn er angestoßen wird. Wir wollen dann einen Plan entwicklen, der dem Roboter hilft das Gleichgewicht zu behalten und nach Möglichkeit auch zu fahren.

\subsection*{Angestrebte Problemlösung}

Wir wollen mit Hilfe des Ultraschellsensors den Abstand zum Boden bestimmen und so festzustellen, in welcher lage sich der Roboter befindet. Sollte der Abstand ergeben, dass er nach vorne oder hinten geneigt ist, wollen wir entsprechend mit einer Beschleunigung nach vorne oder hinten ein Gleichgewicht wiederherstellen.
